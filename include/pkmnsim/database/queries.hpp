...
namespace pkmnsim
{
    namespace database
    {
         ...
         */
        int get_ability_id_from_name(std::string ability_name);

        /*
         * Get the ability name associated with the specified ID.
         */
        std::string get_ability_name_from_id(int ability_id);

        /*
         * Get the database move ID associated with the specified name.
         */
        int get_move_id_from_name(std::string move_name);

        /*
         * Get the move name associated with the specified ID.
         */
        std::string get_move_name_from_id(int move_id);

        /*
         * Get the database nature ID associated with the specified name.
         */
        int get_nature_id_from_name(std::string nature_name);

        /*
         * Get the nature name associated with the specified ID.
         */
        std::string get_nature_name_from_id(int nature_id);
         ...
         */
        std::string get_species_name_from_id(int species_id);

        /*
         * Get the database type ID associated with the specified name.
         */
        int get_type_id_from_name(std::string type_name);

        /*
         * Get the type name associated with the specified ID.
         */
        std::string get_type_name_from_id(int type_id);
    }
}
