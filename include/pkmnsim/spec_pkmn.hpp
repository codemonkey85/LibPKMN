...
class spec_pkmn
{
    ...
    private:
        ...
        */
        ...
        int determine_nature();
        int get_hp_from_iv(int);
        int get_stat_from_iv(int); //for others besides HP
        int get_iv_from_hp(int);
        int get_iv_from_stat(int); //for others besides HP
        void init_volative_status_map(); //Can also reset
}
