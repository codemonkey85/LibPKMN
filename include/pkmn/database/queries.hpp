...
namespace pkmn
{
    namespace database
    {
        std::string PKMN_API to_database_format(std::string identifier);
     
        unsigned int PKMN_API get_ability_id(std::string ability_name);
        std::string PKMN_API get_ability_name(unsigned int ability_id);

        unsigned int PKMN_API get_damage_class(unsigned int type_id);
        
        unsigned int PKMN_API get_egg_group_id(std::string egg_group_name);
        std::string PKMN_API get_egg_group_name(unsigned int egg_group_id);
        
        unsigned int PKMN_API get_game_id(std::string game_name);
        std::string PKMN_API get_game_name(unsigned int game_id);
        ...
        std::string PKMN_API get_item_description(unsigned int item_id, unsigned int version);
        std::string PKMN_API get_item_description(std::string name, unsigned int version);
        
        unsigned int PKMN_API get_item_id(std::string item_name);
        unsigned int PKMN_API get_item_id(unsigned int item_index, unsigned int game);
        std::string PKMN_API get_item_name(unsigned int item_id);

        unsigned int PKMN_API get_item_category(unsigned int item_id);
        unsigned int PKMN_API get_item_category(std::string item_name);
        
        std::string PKMN_API get_move_description(unsigned int move_id, unsigned int version);
        std::string PKMN_API get_move_description(std::string move_name, unsigned int version);
        
        unsigned int PKMN_API get_move_id(std::string move_name);
        std::string PKMN_API get_move_name(unsigned int move_id);
        ...
        unsigned int PKMN_API get_nature_id(std::string nature_name);
        std::string PKMN_API get_nature_name(unsigned int nature_id);
        ...
        unsigned int PKMN_API get_version_group(unsigned int version_id);
    }
}
