...
public class PokemonTextTest
{
    public static int Main(string[] args)
    {
        ...
        test_dict1.insert("TestKey1", -10);
        test_dict1.insert("TestKey2", -5);
        test_dict1.insert("TestKey3", 0);
        test_dict1.insert("TestKey4", 5);
        test_dict1.insert("TestKey5", 10);
        ...
        {
            if(test_dict2.at(test_dict2_keys[i]) != test_cs_dict2[test_dict2_keys[i]])
            {
        ...
        test_dict3.insert("TestKey1", "TestValue1");
        test_dict3.insert("TestKey2", "TestValue2");
        test_dict3.insert("TestKey3", "TestValue3");
        test_dict3.insert("TestKey4", "TestValue4");
        test_dict3.insert("TestKey5", "TestValue5");
        ...
        test_dict5.insert("TestKey1", 0);
        test_dict5.insert("TestKey2", 5);
        test_dict5.insert("TestKey3", 10);
        test_dict5.insert("TestKey4", 15);
        test_dict5.insert("TestKey5", 20);
        ...
        {
            if(test_dict6.at(test_dict6_keys[i]) != test_cs_dict6[test_dict6_keys[i]])
            {
