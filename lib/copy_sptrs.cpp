...
namespace pkmn
{
    ...
    base_pokemon::sptr copy_base_pokemon(base_pokemon::sptr in)
    {
        switch(in->get_generation()) //Generation determines implementation class
        {
            case 1:
            {
                ...
                return pkmn::dynamic_pointer_cast<base_pokemon>(pkmn::make_shared<base_pokemon_gen1impl>(actual1));
            }

            case 2:
            {
                base_pokemon_gen2impl actual2 = *pkmn::dynamic_pointer_cast<base_pokemon_gen2impl>(in);
                return pkmn::dynamic_pointer_cast<base_pokemon>(pkmn::make_shared<base_pokemon_gen2impl>(actual2));
            }

            default:
            {
                base_pokemon_modernimpl actual3 = *pkmn::dynamic_pointer_cast<base_pokemon_modernimpl>(in);
                return pkmn::dynamic_pointer_cast<base_pokemon>(pkmn::make_shared<base_pokemon_modernimpl>(actual3));
            }
        }
    }
    ...
    game_save::sptr copy_game_save(game_save::sptr in)
    {
        switch(database::get_generation(in->get_game_id())) //Generation determines implementation class
        {
            ...
            case 3:
            {
                ...
                return pkmn::dynamic_pointer_cast<game_save>(pkmn::make_shared<game_save_gen3impl>(actual3));
            }
            case 4:
            {
    ...
    item::sptr copy_item(item::sptr in)
    {
           ...
           or (id >= Items::TM96 and id <= Items::TM100))
        {
            ...
            return pkmn::dynamic_pointer_cast<item>(pkmn::make_shared<item_machineimpl>(actual_machine));
        }
                ...
                or (id >= Items::BERRY and id <= Items::MYSTERYBERRY))
        {
            ...
            return pkmn::dynamic_pointer_cast<item>(pkmn::make_shared<item_berryimpl>(actual_berry));
        }
        else
        {
            item_impl actual = *pkmn::dynamic_pointer_cast<item_impl>(in);
            return pkmn::dynamic_pointer_cast<item>(pkmn::make_shared<item_impl>(actual));
        }
    }
    ...
    move::sptr copy_move(move::sptr in)
    {
        ...
        return pkmn::dynamic_pointer_cast<move>(pkmn::make_shared<move_impl>(actual));
    }
    ...
    team_pokemon::sptr copy_team_pokemon(team_pokemon::sptr in)
    {
        switch(in->get_generation()) //Generation determines implementation class
        {
            case 1:
            {
                ...
                return pkmn::dynamic_pointer_cast<team_pokemon>(pkmn::make_shared<team_pokemon_gen1impl>(actual1));
            }

            case 2:
            {
                team_pokemon_gen2impl actual2 = *pkmn::dynamic_pointer_cast<team_pokemon_gen2impl>(in);
                return pkmn::dynamic_pointer_cast<team_pokemon>(pkmn::make_shared<team_pokemon_gen2impl>(actual2));
            }

            default:
            {
                team_pokemon_modernimpl actual3 = *pkmn::dynamic_pointer_cast<team_pokemon_modernimpl>(in);
                return pkmn::dynamic_pointer_cast<team_pokemon>(pkmn::make_shared<team_pokemon_modernimpl>(actual3));
            }
        }
    }
