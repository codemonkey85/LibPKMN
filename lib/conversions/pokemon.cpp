...
namespace pkmnsim
{
    namespace conversions
    {
                                              ...
                                              pokemon_growth_t* pkmn_g_t)
        {
            ...
            uint32_t* ribbonint = &(pkmn_m_t->ribbonint);
            set_ribbon(ribbonint, Ribbons::Hoenn::COOL, attributes.get("hoenn_cool_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::COOL_SUPER, attributes.get("hoenn_cool_super_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::COOL_HYPER, attributes.get("hoenn_cool_hyper_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::COOL_MASTER, attributes.get("hoenn_cool_master_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::BEAUTY, attributes.get("hoenn_beauty_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::BEAUTY_SUPER, attributes.get("hoenn_beauty_super_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::BEAUTY_HYPER, attributes.get("hoenn_beauty_hyper_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::BEAUTY_MASTER, attributes.get("hoenn_beauty_master_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::CUTE, attributes.get("hoenn_cute_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::CUTE_SUPER, attributes.get("hoenn_cute_super_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::CUTE_HYPER, attributes.get("hoenn_cute_hyper_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::CUTE_MASTER, attributes.get("hoenn_cute_master_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::SMART, attributes.get("hoenn_smart_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::SMART_SUPER, attributes.get("hoenn_smart_super_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::SMART_HYPER, attributes.get("hoenn_smart_hyper_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::SMART_MASTER, attributes.get("hoenn_smart_master_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::TOUGH, attributes.get("hoenn_tough_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::TOUGH_SUPER, attributes.get("hoenn_tough_super_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::TOUGH_HYPER, attributes.get("hoenn_tough_hyper_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::TOUGH_MASTER, attributes.get("hoenn_tough_master_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::CHAMPION, attributes.get("hoenn_champion_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::WINNING, attributes.get("hoenn_winning_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::VICTORY, attributes.get("hoenn_victory_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::ARTIST, attributes.get("hoenn_artist_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::EFFORT, attributes.get("hoenn_effort_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::MARINE, attributes.get("hoenn_marine_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::LAND, attributes.get("hoenn_land_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::SKY, attributes.get("hoenn_sky_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::COUNTRY, attributes.get("hoenn_country_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::NATIONAL, attributes.get("hoenn_national_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::EARTH, attributes.get("hoenn_earth_ribbon",false));
            set_ribbon(ribbonint, Ribbons::Hoenn::WORLD, attributes.get("hoenn_world_ribbon",false));
        }
        ...
        PokeLib::Pokemon team_pokemon_to_pokelib_pokemon(team_pokemon::sptr t_pkmn)
        {
            ...
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::DOUBLE_ABILITY, attributes.get("sinnoh_double_ability_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::MULTI_ABILITY, attributes.get("sinnoh_multi_ability_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::PAIR_ABILITY, attributes.get("sinnoh_pair_ability_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::WORLD_ABILITY, attributes.get("sinnoh_world_ability_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::ALERT, attributes.get("sinnoh_alert_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::SHOCK, attributes.get("sinnoh_shock_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::DOWNCAST, attributes.get("sinnoh_downcast_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::CARELESS, attributes.get("sinnoh_careless_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::RELAX, attributes.get("sinnoh_relax_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::ALERT, attributes.get("sinnoh_alert_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::SHOCK, attributes.get("sinnoh_shock_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::DOWNCAST, attributes.get("sinnoh_downcast_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::CARELESS, attributes.get("sinnoh_careless_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::RELAX, attributes.get("sinnoh_relax_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::SNOOZE, attributes.get("sinnoh_snooze_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::SMILE, attributes.get("sinnoh_smile_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::GORGEOUS, attributes.get("sinnoh_gorgeous_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::ROYAL, attributes.get("sinnoh_royal_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::GORGEOUS_ROYAL, attributes.get("sinnoh_gorgeous_royal_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::RECORD, attributes.get("sinnoh_record_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::HISTORY, attributes.get("sinnoh_history_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::LEGEND, attributes.get("sinnoh_legend_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::RED, attributes.get("sinnoh_red_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::GREEN, attributes.get("sinnoh_green_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::BLUE, attributes.get("sinnoh_blue_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::FESTIVAL, attributes.get("sinnoh_festival_ribbon",false));
            set_ribbon(ribbonSinnohA, Ribbons::Sinnoh::CARNIVAL, attributes.get("sinnoh_carnival_ribbon",false));
            ...
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::COOL_MASTER, attributes.get("hoenn_cool_master_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::BEAUTY, attributes.get("hoenn_beauty_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::BEAUTY_SUPER, attributes.get("hoenn_beauty_super_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::BEAUTY_HYPER, attributes.get("hoenn_beauty_hyper_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::BEAUTY_MASTER, attributes.get("hoenn_beauty_master_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::CUTE, attributes.get("hoenn_cute_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::CUTE_SUPER, attributes.get("hoenn_cute_super_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::CUTE_HYPER, attributes.get("hoenn_cute_hyper_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::CUTE_MASTER, attributes.get("hoenn_cute_master_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::SMART, attributes.get("hoenn_smart_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::SMART_SUPER, attributes.get("hoenn_smart_super_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::SMART_HYPER, attributes.get("hoenn_smart_hyper_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::SMART_MASTER, attributes.get("hoenn_smart_master_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::TOUGH, attributes.get("hoenn_tough_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::TOUGH_SUPER, attributes.get("hoenn_tough_super_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::TOUGH_HYPER, attributes.get("hoenn_tough_hyper_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::TOUGH_MASTER, attributes.get("hoenn_tough_master_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::CHAMPION, attributes.get("hoenn_champion_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::WINNING, attributes.get("hoenn_winning_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::VICTORY, attributes.get("hoenn_victory_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::ARTIST, attributes.get("hoenn_artist_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::EFFORT, attributes.get("hoenn_effort_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::MARINE, attributes.get("hoenn_marine_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::LAND, attributes.get("hoenn_land_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::SKY, attributes.get("hoenn_sky_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::COUNTRY, attributes.get("hoenn_country_ribbon",false));
            set_ribbon(ribbonHoenn, Ribbons::Hoenn::NATIONAL, attributes.get("hoenn_national_ribbon",false));
            ...
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::COOL_MASTER-23, attributes.get("sinnoh_cool_master_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::BEAUTY-23, attributes.get("sinnoh_beauty_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::BEAUTY_GREAT-23, attributes.get("sinnoh_beauty_great_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::BEAUTY_ULTRA-23, attributes.get("sinnoh_beauty_ultra_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::BEAUTY_MASTER-23, attributes.get("sinnoh_beauty_master_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::CUTE-23, attributes.get("sinnoh_cute_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::CUTE_GREAT-23, attributes.get("sinnoh_cute_great_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::CUTE_ULTRA-23, attributes.get("sinnoh_cute_ultra_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::CUTE_MASTER-23, attributes.get("sinnoh_cute_master_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::SMART-23, attributes.get("sinnoh_smart_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::SMART_GREAT-23, attributes.get("sinnoh_smart_great_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::SMART_ULTRA-23, attributes.get("sinnoh_smart_ultra_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::SMART_MASTER-23, attributes.get("sinnoh_smart_master_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::TOUGH-23, attributes.get("sinnoh_tough_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::TOUGH_GREAT-23, attributes.get("sinnoh_tough_great_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::TOUGH_ULTRA-23, attributes.get("sinnoh_tough_ultra_ribbon",false));
            set_ribbon(ribbonSinnohB, Ribbons::Sinnoh::TOUGH_MASTER-23, attributes.get("sinnoh_tough_master_ribbon",false));
        ...
        void team_pokemon_to_pkmds_g5_pokemon(team_pokemon::sptr t_pkmn, party_pkm* p_pkm)
        {
            ...
            uint32_t* hribbon1 = reinterpret_cast<uint32_t*>(&(p_pkm->pkm_data.hribbon1));
            set_ribbon(hribbon1, Ribbons::Hoenn::COOL, attributes.get("hoenn_cool_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::COOL_SUPER, attributes.get("hoenn_cool_super_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::COOL_HYPER, attributes.get("hoenn_cool_hyper_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::COOL_MASTER, attributes.get("hoenn_cool_master_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::BEAUTY, attributes.get("hoenn_beauty_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::BEAUTY_SUPER, attributes.get("hoenn_beauty_super_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::BEAUTY_HYPER, attributes.get("hoenn_beauty_hyper_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::BEAUTY_MASTER, attributes.get("hoenn_beauty_master_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::CUTE, attributes.get("hoenn_cute_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::CUTE_SUPER, attributes.get("hoenn_cute_super_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::CUTE_HYPER, attributes.get("hoenn_cute_hyper_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::CUTE_MASTER, attributes.get("hoenn_cute_master_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::SMART, attributes.get("hoenn_smart_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::SMART_SUPER, attributes.get("hoenn_smart_super_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::SMART_HYPER, attributes.get("hoenn_smart_hyper_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::SMART_MASTER, attributes.get("hoenn_smart_master_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::TOUGH, attributes.get("hoenn_tough_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::TOUGH_SUPER, attributes.get("hoenn_tough_super_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::TOUGH_HYPER, attributes.get("hoenn_tough_hyper_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::TOUGH_MASTER, attributes.get("hoenn_tough_master_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::CHAMPION, attributes.get("hoenn_champion_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::WINNING, attributes.get("hoenn_winning_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::VICTORY, attributes.get("hoenn_victory_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::ARTIST, attributes.get("hoenn_artist_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::EFFORT, attributes.get("hoenn_effort_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::MARINE, attributes.get("hoenn_marine_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::LAND, attributes.get("hoenn_land_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::SKY, attributes.get("hoenn_sky_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::COUNTRY, attributes.get("hoenn_country_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::NATIONAL, attributes.get("hoenn_national_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::EARTH, attributes.get("hoenn_earth_ribbon",false));
            set_ribbon(hribbon1, Ribbons::Hoenn::WORLD, attributes.get("hoenn_world_ribbon",false));

            uint32_t* sribbon1 = reinterpret_cast<uint32_t*>(&(p_pkm->pkm_data.sribbon1));
            set_ribbon(sribbon1, Ribbons::Sinnoh::CHAMPION, attributes.get("sinnoh_champion_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::ABILITY, attributes.get("sinnoh_ability_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::GREAT_ABILITY, attributes.get("sinnoh_great_ability_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::DOUBLE_ABILITY, attributes.get("sinnoh_double_ability_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::MULTI_ABILITY, attributes.get("sinnoh_multi_ability_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::PAIR_ABILITY, attributes.get("sinnoh_pair_ability_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::WORLD_ABILITY, attributes.get("sinnoh_ability_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::ALERT, attributes.get("sinnoh_alert_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::SHOCK, attributes.get("sinnoh_shock_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::DOWNCAST, attributes.get("sinnoh_downcast_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::CARELESS, attributes.get("sinnoh_careless_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::RELAX, attributes.get("sinnoh_relax_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::SNOOZE, attributes.get("sinnoh_snooze_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::SMILE, attributes.get("sinnoh_smile_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::GORGEOUS, attributes.get("sinnoh_gorgeous_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::ROYAL, attributes.get("sinnoh_royal_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::GORGEOUS_ROYAL, attributes.get("sinnoh_gorgeous_royal_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::RECORD, attributes.get("sinnoh_record_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::HISTORY, attributes.get("sinnoh_history_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::LEGEND, attributes.get("sinnoh_legend_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::RED, attributes.get("sinnoh_red_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::GREEN, attributes.get("sinnoh_green_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::BLUE, attributes.get("sinnoh_blue_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::FESTIVAL, attributes.get("sinnoh_festival_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::CARNIVAL, attributes.get("sinnoh_carnival_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::CLASSIC, attributes.get("sinnoh_classic_ribbon",false));
            set_ribbon(sribbon1, Ribbons::Sinnoh::PREMIER, attributes.get("sinnoh_premier_ribbon",false));

            uint32_t* sribbon3 = reinterpret_cast<uint32_t*>(&(p_pkm->pkm_data.sribbon3));
            set_ribbon(sribbon3, Ribbons::Sinnoh::COOL-23, attributes.get("sinnoh_cool_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::COOL_GREAT-23, attributes.get("sinnoh_cool_great_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::COOL_ULTRA-23, attributes.get("sinnoh_cool_ultra_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::COOL_MASTER-23, attributes.get("sinnoh_cool_master_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::BEAUTY-23, attributes.get("sinnoh_beauty_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::BEAUTY_GREAT-23, attributes.get("sinnoh_beauty_great_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::BEAUTY_ULTRA-23, attributes.get("sinnoh_beauty_ultra_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::BEAUTY_MASTER-23, attributes.get("sinnoh_beauty_master_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::CUTE-23, attributes.get("sinnoh_cute_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::CUTE_GREAT-23, attributes.get("sinnoh_cute_great_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::CUTE_ULTRA-23, attributes.get("sinnoh_cute_ultra_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::CUTE_MASTER-23, attributes.get("sinnoh_cute_master_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::SMART-23, attributes.get("sinnoh_smart_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::SMART_GREAT-23, attributes.get("sinnoh_smart_great_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::SMART_ULTRA-23, attributes.get("sinnoh_smart_ultra_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::SMART_MASTER-23, attributes.get("sinnoh_smart_master_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::TOUGH-23, attributes.get("sinnoh_tough_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::TOUGH_GREAT-23, attributes.get("sinnoh_tough_great_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::TOUGH_ULTRA-23, attributes.get("sinnoh_tough_ultra_ribbon",false));
            set_ribbon(sribbon3, Ribbons::Sinnoh::TOUGH_MASTER-23, attributes.get("sinnoh_tough_master_ribbon",false));
