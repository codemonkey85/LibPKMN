...
#define RS_ITEM_POCKET_OFFSET 0x560
#define RS_KEY_ITEM_POCKET_OFFSET 0x5B0
#define RS_BALL_POCKET_OFFSET 0x600
#define RS_TM_POCKET_OFFSET 0x640
#define RS_BERRY_POCKET_OFFSET 0x740

#define E_ITEM_POCKET_OFFSET 0x560
#define E_KEY_ITEM_POCKET_OFFSET 0x5D8
#define E_BALL_POCKET_OFFSET 0x650
#define E_TM_POCKET_OFFSET 0x690
#define E_BERRY_POCKET_OFFSET 0x790

#define FRLG_ITEM_POCKET_OFFSET 0x310
#define FRLG_KEY_ITEM_POCKET_OFFSET 0x3B8
#define FRLG_BALL_POCKET_OFFSET 0x430
#define FRLG_TM_POCKET_OFFSET 0x464
#define FRLG_BERRY_POCKET_OFFSET 0x54C
